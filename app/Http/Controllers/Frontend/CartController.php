...
class CartController extends Controller
{
    ...
    public function InsCouponApply(Request $request){
        ...
        if($coupon){
            if($coupon->course_id == $request->course_id && $coupon->instructor_id == $request->instructor_id){
                ...
                return response()->json(['error' => 'Coupon Criteria does not meet for this course and instructor']);
    ...
    public function Payment(Request $request){
        ...
        if($request->cash_delivery == 'stripe'){
            ...
            $orderData = [
                'receipt' => Auth::user()->id. '_' . time(),
                'amount' => $total_amount * 100, // Convert price to paise
                'currency' => 'INR',
                'payment_capture' => 1,
             ];
            ...
            $data["razorpay_key"] = config('services.razorpay.key');
            ...
            $attributes = [
             ...
             try {
                ...
                foreach($carts as $cart){
                    ...
                    $order->instructor_id = $cart->options->instructor;
                    $order->course_title = $cart->options->name;
        ...
        public function StripeOrderOld(Request $request){
            dd($request->all());
            if(Session::has('coupon')){
                $total_amount = Session::get('coupon')['total_amount'];
            }else{
            ...
            \Stripe\Stripe::setApiKey('sk_test_51PNs8wRwbK4T6QHqD3oJ5VMd42H9EZPutXfQlZPnA6DDMQAXvpPX2Ge8gC4FJHsAg2PLBLnTG8oEaDlvoGQaMXi800DIHDt7Rg');
