    ...
    <div class="container">
        ...
        <div class="input-box">
            ...
            <div class="form-group">
                <input class="form-control form--control" type="text" id="name" name="name" placeholder="Enter name">
        ...
        <div class="input-box">
            ...
            <div class="form-group">
                <input class="form-control form--control" type="email" id="email" name="email" placeholder="Enter email">
                <span class="la la-user input-icon"></span>
            </div>
        </div><!-- end input-box -->
        <div class="input-box">
            ...
            <div class="form-group">
                <input class="form-control form--control" type="password" id="password" name="password" placeholder="Enter password">
                <span class="la la-user input-icon"></span>
            </div>
        </div><!-- end input-box -->
        <div class="input-box">
