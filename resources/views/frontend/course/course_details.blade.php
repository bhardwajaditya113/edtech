                   ...
                   <div class="course-overview-card">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       ...
                       <p class="fs-15 pb-1">Get your team access to Gyanpeeth's top 5,000+ courses</p>
                        <div class="pb-3">
                            <img width="85" class="mr-3" src="{{ asset('frontend/images/facebook.png')}}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('frontend/images/amazon.png')}}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('frontend/images/google.png')}}" alt="company logo">
                            <img width="70" class="mr-3" src="{{ asset('frontend/images/netflix.png')}}" alt="company logo">
                            <img width="70" class="mr-3" src="{{ asset('frontend/images/microsoft.png')}}" alt="company logo">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{ getImageUrl($course->course_image) }}" data-src="{{ getImageUrl($course->course_image) }}" alt="course-img" class="w-100 rounded lazy">
                ...
                <div class="card card-item">
                    <div class="card-image">
                        <a href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}" class="d-block">
                            <img class="card-img-top" src="{{ getImageUrl($inscourse->course_image) }}" alt="Card image cap">
                        </a>
