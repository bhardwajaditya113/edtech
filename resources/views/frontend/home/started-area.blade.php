    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center" style="margin-left: 100px;">
                    <div class="card-body">
                        ...
                        <p class="card-text">Teach what you love. Gyanpeeth Global gives you the tools to create a course.</p>
            ...
            {{-- <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Gyanpeeth Global for Business</h5>
                        <p class="card-text">Get unlimited access to 5,000+ of Gyanpeeth's top courses for your team</p>
                        <div class="btn-box mt-20px">
                            <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="la la-briefcase mr-1"></i>Get Gyanpeeth Global for business</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 --> --}}
