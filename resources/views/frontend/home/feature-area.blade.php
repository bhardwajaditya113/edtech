        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Our instructors are experienced professionals and thought leaders in their fields. With years of real-world expertise, they bring practical insights and valuable knowledge to help you succeed in your learning journey.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Whether you have a question about course content, need clarification on assignments, or want guidance on your career path, our platform makes it easy to connect with instructors and peers. Engage in discussions, ask questions, and receive personalized support whenever you need it.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Upon completing your course, earn a certificate that showcases your newly acquired skills. These certificates are a great way to demonstrate your expertise to employers and enhance your resume for new opportunities.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
