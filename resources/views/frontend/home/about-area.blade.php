...
<<<<<<< HEAD
                        <h2 class="section__title">Benefits of Learning With Gyanpeeth Global</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc">
                            At Gyanpeeth Global, we are committed to providing a transformative learning experience that empowers you to reach your fullest potential to provide world-class education at your fingertips
=======
...
<<<<<<< HEAD
                                <h4 class="fs-20 font-weight-semi-bold pt-3">10,000 Courses</h4>
=======
...
>>>>>>> fdea064c21b524e04fa06c265b662633c888f77f
                    ...
                    <div class="btn-box">
<<<<<<< HEAD
                        <a href="#" class="btn theme-btn">Learn More <i class="la la-arrow-right icon ml-1"></i></a>
=======
...
<<<<<<< HEAD
                    <img src="{{ asset('frontend/images/edutech.jpg') }}" data-src="images/img13.jpg" alt="About image" class="img__item img__item-1 lazy">
                    <img src="{{ asset('frontend/images/edutech-2.jpg')}}" data-src="images/img14.jpg" alt="About image" class="img__item img__item-2 lazy">
=======
                    <img src="{{ asset('frontend/images/img-loading.png') }}" data-src="images/img13.jpg" alt="About image" class="img__item img__item-1 lazy">
                    <img src="{{ asset('frontend/images/img-loading.png')}}" data-src="images/img14.jpg" alt="About image" class="img__item img__item-2 lazy">
>>>>>>> fdea064c21b524e04fa06c265b662633c888f77f
