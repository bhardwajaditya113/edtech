                    ...
                    <div class="card card-item">
                        <div class="card-image">
                            <a href="/course/details/${value.course.id}/${value.course.course_name_slug}" class="d-block">
                                <img class="card-img-top" src="{{ getImageUrl('${value.options.image}')}}" alt="Card image cap">
                            </a>
                        </div><!-- end card-image -->
                    ...
                    miniCart += `
                           ...
                           <li class="media media-card">
                                    <a href="shopping-cart.html" class="media-img">
                                        <img src="{{ getImageUrl('${value.options.image}')}}" alt="Cart image">
                                    </a>
