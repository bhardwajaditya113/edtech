            ...
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('store.admin') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="username" type="text" class="form-control" id="input1" >
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input name="phone" type="text" class="form-control" id="input1" >
                    </div>

                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Address</label>
                        <input name="address" type="text" class="form-control" id="input1" >
                    </div>

                    
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Password</label>
                        <input name="password" type="password" class="form-control" id="input1" >
                    </div>
