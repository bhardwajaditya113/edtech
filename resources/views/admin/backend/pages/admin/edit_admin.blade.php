            ...
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('update.admin', $user->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Username</label>
                        <input name="username" type="text" class="form-control" id="input1" value="{{ $user->username }}" >
                    </div>

                    
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Name</label>
                        <input name="name" type="text" class="form-control" id="input1" value="{{ $user->name }}">
                    </div>

                    
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Email</label>
                        <input name="email" type="email" class="form-control" id="input1" value="{{ $user->email }}">
                    </div>

                    
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Phone</label>
                        <input name="phone" type="text" class="form-control" id="input1" value="{{ $user->phone }}">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Admin Address</label>
                        <input name="address" type="text" class="form-control" id="input1" value="{{ $user->address }}">
                    </div>
