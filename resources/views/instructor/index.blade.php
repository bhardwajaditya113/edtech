           ...
           <div class="card-body">
               <div class="d-flex align-items-center">
                   <div>
                       ...
                       <h4 class="my-1 text-danger">{{$course}}</h4>
           ...
           <div class="card-body">
               <div class="d-flex align-items-center">
                   <div>
                       ...
                       <h4 class="my-1 text-success">{{$questions}}</h4>
           ...
           <div class="card-body">
               <div class="d-flex align-items-center">
                   <div>
                       ...
                       <h4 class="my-1 text-warning">{{$coupons}}</h4>
              ...
              <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                <div class="col">
                  <div class="p-3">
                    ...
                    <small class="mb-0">Income</small>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">{{$orders}}</h5>
                    <small class="mb-0">Orders</small>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">{{$course}}</h5>
                    <small class="mb-0">Course </small>
                  </div>
                </div>
              </div>
          </div>
