                ...
                <form id="myForm" action="{{ route('update.course') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="label" class="form-select mb-3" aria-label="Default select example">
                            ...
                            <option value="Advanced" {{ $course->label == 'Advanced' ? 'selected' : '' }}>Advaned</option>
                        </select>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" name="bestseller" id="flexCheckDefault" {{ $course->bestseller == '1' ? 'checked' : '' }} >
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" name="featured" id="flexCheckDefault" {{ $course->featured == '1' ? 'checked' : '' }} >
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" name="highestrated" id="flexCheckDefault" {{ $course->highestrated == '1' ? 'checked' : '' }} >
        ...
        <div class="card-body">
            <form action="{{ route('update.course.image') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">                        
                    <img id="showImage" src="{{ getImageUrl($course->course_image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
        ...
        <div class="card-body">
            <form action="{{ route('update.course.video') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="input2" class="form-label">Course Video Intro</label>
                        <input class="form-control" name="video" type="file" accept="video/mp4, video/webm">
                    </div>
