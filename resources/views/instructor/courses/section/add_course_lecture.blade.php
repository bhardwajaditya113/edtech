            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <img src="{{ getImageUrl($course->course_image) }}" class="rounded-circle p-1 border" width="90" height="90" alt="...">
...
<script>
    function saveLecture(courseId, sectionId, containerId){
        ...
        const lectureVideo = $('#video_url')[0].files[0]; //lectureContainer.querySelector('input[name="url"]');

        var data = new FormData();
        data.append('course_id', courseId);
        data.append('lecture_url', lectureVideo);
        data.append('section_id', sectionId);
        data.append('lecture_title', lectureTitle);
        data.append('content', lectureContent);
